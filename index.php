...
echo "<hr />";
echo '17 &#9989. Напишите функцию определения суммарного количества единиц в числах
от 1 до 100.' . "<br><br>";
function sumSto(){
    $total=0;
    for ($i = 1; $i <100; $i++){
    $total += substr_count(strval($i), 1);
}
return $total;
}
echo sumSto();
...
echo "<hr />";
echo '18 &#9989. Напишите функцию, которая разбивает длинную строку тегами <br> так,
